"""Rebuilds raw_generation.ipynb with run_evaluation containing a tqdm progress bar."""
import json
...
# 0 - main imports
cells.append(code_cell("9652dd28", [
...
# 1 - get_llm
cells.append(code_cell("1b901e51", [
...
# 2 - display_graph
cells.append(code_cell("f2df094a", [
    "def display_graph(graph: CompiledStateGraph):\n",
    "    display(Image(graph.get_graph().draw_mermaid_png()))",
]))

# 3 - ReportState
cells.append(code_cell("b7b3db1e", [
...
# 4 - markdown DB
cells.append(md_cell("f70a7a04", "## DB"))

# 5 - DB imports
cells.append(code_cell("8e35d1c5", [
...
# 6 - session_factory
cells.append(code_cell("c003ae59", [
    "session_factory = get_async_sessionmaker()",
]))

# 7 - markdown Notes
cells.append(md_cell("7644be00", "# Notes"))

# 8 - datetime import
cells.append(code_cell("cde59dc9", [
    "from datetime import timedelta\n",
    "from sqlalchemy import extract\n",
]))

# 9 - DB functions
cells.append(code_cell("96bdac30", [
    ...
    "                entry_id=e.id,\n",
    "                text=e.note,\n",
    "                embedding=list(e.embedding_mini) if e.embedding_mini is not None else [],\n",
    "                date=e.date_note,\n",
    "                goal_id=e.goal_id,\n",
    "                relevance_score=1.0,\n",
    "            )\n",
...
# 10 - markdown Final generation
cells.append(md_cell("71dd45fd", "## Final generation"))

# 11 - import prompts
cells.append(code_cell("1cb179f5", [
...
# 12 - create_report
cells.append(code_cell("db1c1003", [
    "import time\n",
...
# 13 - graph compile
cells.append(code_cell("be40fe2f", [
...
# 14 - markdown Testing
cells.append(md_cell("af3a0f45", "## Testing"))

# 15 - testing helpers
cells.append(code_cell("41259624", [
...
# 16 - get_periods_for_user + run_evaluation (WITH tqdm progress bar)
cells.append(code_cell("9866c1ef", [
...
# 17 - await run_evaluation
cells.append(code_cell("de6ab5d0", ["await run_evaluation()"]))
...
out = "e:/projects/University/BKR/bcr-app/packages/backend/notebooks/experiments/raw_generation.ipynb"
